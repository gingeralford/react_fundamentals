...
const key = 'VbeT8eGq9bGUAAVz4SvfycpS0Xy6XPAo';
...
const NytApp = () => {
  ...
  //a function, not a functional component
  const fetchResults = () => {
  ...
  //function, not functional component
 ...
 <div className="main">
   <div className="mainDiv">
     ...
     {/* Made this "changePageNumber" instead of "ChangePageNumber" */}
    </div>
  </div>
 );
  }
